%
%   TE_sin   Evaluation of Taylor Series Expansions
%
%   This code simply illustrates how to evaluate an infinite series
%   sinansion for a particular function, f(x). The key here is to 
...
%
      ...
      NT = n;                          % number of terms used in sinansion
%
%   plot results
%
      figure(1)
      ...
      grid
      title(['Evaluating TE Series of sin (n = ',num2str(NT), ')']); 
      xlabel('x'),
      ylabel('f(x)')
